...
public class calculator {
    ...
    */
     ...
     */
    public double solvePattern(){
        parseMainString();
        return solver(this.parsed);
    }
    /**
    ...
    */
    private double solver(ArrayList<String> parsed){
        //this for will delete all posibly white items in parsed array
        for(int i=0;i<parsed.size();i++){
            String word=parsed.get(i);
            if(word.equals(""))
                parsed.remove(i);
        }
        return calculator(parsed);
    }
    /**
     * 
